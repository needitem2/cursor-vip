...
```bash
bash <(curl -Lk https://github.com/kingparks/cursor-vip/releases/download/latest/i.sh) ee43a840c9724694a9b57a96dfbcafef  
```
Method 2: Install via ghp.ci proxy script
```bash
bash <(curl -Lk https://ghp.ci/https://github.com/kingparks/cursor-vip/releases/download/latest/install.sh) ee43a840c9724694a9b57a96dfbcafef  
```
...
cursor-vip ee43a840c9724694a9b57a96dfbcafef;
# Windows 
